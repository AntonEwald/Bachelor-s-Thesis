...
```{r}
kable(df_PB_Herring, format = "latex", caption = "Result for Tobit model on data for PB in Herring")
kable(df_NI_Herring, format = "latex",caption = "Result for Tobit model on data for NI in Herring")
kable(df_CR_Herring, format = "latex", caption = "Result for Tobit model on data for PB in Herring")
```
