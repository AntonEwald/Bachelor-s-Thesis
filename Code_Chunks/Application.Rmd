...
thesis_CR_Table <- kable(for_thesis_CR_df, booktabs=T, escape=F, format = "latex", align = "l", caption = "Results of application of both models on data for chromium concentrations in herring (Estimated slope on Log-Scale)") %>% 
...
thesis_NI_Table <- kable(for_thesis_NI_df, booktabs=T, escape=F, format = "latex", align = "l", caption = "Results of application of both models on data for nickel concentrations in herring (Estimated slope on Log-Scale)") %>% 
column_spec(1, bold=T) %>% 
  kable_styling(latex_options="scale_down")

thesis_PB_Table <- kable(for_thesis_PB_df, booktabs=T, escape=F, format = "latex", align = "l", caption = "Results of application of both models on data for lead concentrations in herring (Estimated slope on Log-Scale)") %>% 
column_spec(1, bold=T) %>% 
  kable_styling(latex_options="scale_down")
